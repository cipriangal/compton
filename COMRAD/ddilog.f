*
* $Id: ddilog.F,v 1.10 2001/10/08 14:03:13 mclareni Exp $
*
* $Log: ddilog.F,v $
* Revision 1.10  2001/10/08 14:03:13  mclareni
* Version 7.58 from author
*
*
C#include "sys/CERNLIB_machine.h"
C#include "pilot.h"
C#if defined(CERNLIB_NOCERN)
      DOUBLE PRECISION FUNCTION DDILOG(X)
C
C          FROM CERN PROGRAM LIBRARY
C
C#if defined(CERNLIB_IMPNONE)
      IMPLICIT NONE
C#endif
